...
// void my_littlefs_write(const void *data, size_t size)
// {
//     esp_littlefs_t *efs = (esp_littlefs_t *)_efs[0];
    
//     lfs_file_write(efs->fs, &file, data, size);
// }


// void my_littlefs_read(void *dst, size_t size){
//     esp_littlefs_t * efs = (esp_littlefs_t *)_efs[0];
//     lfs_file_read(efs->fs, &file, dst, size);
// }
...
// void my_littlefs_close(void *dst, size_t size){
//     esp_littlefs_t * efs = (esp_littlefs_t *)_efs[0];

//     lfs_file_close(efs->fs, &file);
// }
                                  ...
                                  struct dirent *entry, struct dirent **out_dirent)
{
    ...
    sem_take(efs);
    do
    { /* Read until we get a real object name */
